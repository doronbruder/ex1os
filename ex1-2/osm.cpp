...
int main(int argc, char **argv){
    double res = osm_operation_time(100000);
    double res1 = osm_function_time(100000);
    double res2 = osm_syscall_time(100000);
    std::cout<<"operation time: "<<res<<"function time: "<<res1<<"syscall time: "<<res2;
    return 0;
}
